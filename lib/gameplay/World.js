...
export class World {
    ...
    async loadEnvironmentMap() {
        try {
            ...
            const texture = await new Promise((resolve, reject) => {
                envMapLoader.load(config.worlds[this.worldID].scene.environmentMap, resolve, undefined, reject);
            });
    ...
    async loadScene() {
        try {
            ...
            const gltf = await new Promise((resolve, reject) => {
                loader.load(config.worlds[this.worldID].scene.modelPath, resolve, undefined, reject);
            });
    ...
    async loadPlayer() {
        try {
            ...
            const gltf = await new Promise((resolve, reject) => {
                loader.load(config.worlds[this.worldID].player.modelPath, resolve, undefined, reject);
            });
