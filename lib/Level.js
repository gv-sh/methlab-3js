...
export class Level {
    ...
    async loadPlayer() {
        try {
            ...
            this.keyboardController = new KeyboardController(this.player, mixer, animationmap, this.controls, this.camera, 'Idle', this.levelID, this.reactStates);
    ...
    isPlayerInsideInteractiveRegion() {
        // Check if the player's position is inside any of the interactive regions
